...
**Note: The video above shows how to create a webhook using an older version of RocketChat. Please follow the written instructions below webhook creation, as they reflect the current version of RocketChat used in this lab.**
...
- Use the command below to benchmark your app using 10,000 requests generated by [`ab` (ApacheBench)](https://httpd.apache.org/docs/current/programs/ab.html)
  ...
  - Using the left navigation menu, select 'Integrations'. Then click 'New' in the top-right corner and choose 'Incoming Webhook'
