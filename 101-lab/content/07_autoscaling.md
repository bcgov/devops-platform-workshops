...
- Use the command below to benchmark your app using 10,000 requests generated by [`ab` (ApacheBench)](https://httpd.apache.org/docs/current/programs/ab.html)
  ...
  # Open RocketChat, click Manage in the top right corner (gear icon) > Workspace >  Integrations > New > Incoming WebHook
...
- In the home page of Rocket.Chat, click on "Join rooms", then the channel #general.
